...
class post_model_trains extends CI_Model{
    ...
    public function get_posts($model=FALSE){
       ...
       $query =$this->db->get_where('trains',array('model'=>$model));
...
$result= mysqli_query($link,$query) or die(mysqli_error()); 
    ...
    public function update_post(){
       ...
       $data=array(
            'model' => $this->input->post('model'),
            'picture' => strval($this->selectfield("SELECT picture FROM trains WHERE id='$id'")),
            'description' =>$this->input->post('description'),
            'age' =>$this->input->post('manufactured')
       ...
       return $this->db->update('trains',$data);
    }
}
